...
const API_KEY = 'f183d971547339e65648db8d92b6ac60';
const COORDS = 'coords';

// api 에서 위도 경도를 가지로 날씨와 장소 받아오기
function Wather(lat, lng){
    fetch(
...
function loadCoords(){
    ...
    if(loadCoords === null){
        ...
        Wather(parseCoords.latitude, parseCoords.longitude);
    }
}
